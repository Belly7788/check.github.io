      ...
      {isSettingPopupOpen && (
        <div
          ...
          style={{
            ...
            left: `${settingPopupPosition.left}px`,
        ...
        >
          <div className="p-3 flex flex-col max-h-96">
            <h3 className="text-center font-semibold mb-3">{t('payment_manage.column_settings')}</h3>
            <div className="mb-3">
              <input
                type="text"
                placeholder={t('payment_manage.search_columns')}
