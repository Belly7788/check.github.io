...
export function Layout({ children }) {
  ...
  useEffect(() => {
    ...
    if (basePath.startsWith("/payment")) setPaymentOpen(true);
        ...
        <nav className="flex w-full flex-col gap-2 pr-4 pl-4 flex-1 overflow-y-auto custom-scrollbar">
            ...
            <div className="w-full">
              ...
              <div
                className={`overflow-hidden transition-all duration-300 ease-in-out ${
                  productOpen && sidebarOpen ? "max-h-96" : "max-h-0"
                }`}
              >
          ...
          {hasShowPOPermission && (
            <div className="w-full">
              ...
              <div
                className={`overflow-hidden transition-all duration-300 ease-in-out ${
                  poOpen && sidebarOpen ? "max-h-96" : "max-h-0"
                }`}
              >
                {poOpen && sidebarOpen && (
                  <div className="ml-8 pl-2 mt-1 space-y-1">
          ...
          {hasShowPIPermission && (
            <div className="w-full">
              ...
              <div
                className={`overflow-hidden transition-all duration-300 ease-in-out ${
                  piOpen && sidebarOpen ? "max-h-96" : "max-h-0"
                }`}
              >
                {piOpen && sidebarOpen && (
          ...
          {/* Payment-Manage Menu with Dropdown */}
          {hasShowPaymentPermission && (
            <div className="w-full">
              ...
              >
                ...
                {sidebarOpen && (
                  <div className="ml-4 flex-1 flex justify-between items-center">
                    <span>{t("payment_manages")}</span>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className={`h-4 w-4 transition-transform duration-200 ${
                        paymentOpen ? "transform rotate-180" : ""
                      }`}
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
              ...
              <div
                className={`overflow-hidden transition-all duration-300 ease-in-out ${
                  paymentOpen && sidebarOpen ? "max-h-96" : "max-h-0"
                }`}
              >
                {paymentOpen && sidebarOpen && (
                  <div className="ml-8 pl-2 mt-1 space-y-1">
                    <NavItem
                      href="/payment"
                      icon={
                    ...
                    <NavItem
                      ...
                      text={t("after_sale")}
                      sidebarOpen={sidebarOpen}
                      active={basePath === "/payment/after-sale"}
                      onClick={() => setActiveMenu("/payment/after-sale")}
                      darkMode={darkMode}
                    />
                  </div>
                )}
            ...
            icon={
              ...
              >
                <path
                  ...
                  strokeLinejoin="round"
                  strokeWidth={2}
                  d="M9 7h6m-3-3v6m6 3H6m3 3h2m-2 3h2m4-3h2m-2 3h2m-8-6h2m-2 3h2m4-3h2"
                />
              </svg>
            }
            text={t("calculator")}
            sidebarOpen={sidebarOpen}
            active={basePath === "/calculator"}
          ...
          {hasShowSettingPermission && (
            <div className="mt-auto w-full mb-4">
              ...
              <div
                className={`overflow-hidden transition-all duration-300 ease-in-out ${
                  settingsOpen && sidebarOpen ? "max-h-96" : "max-h-0"
                }`}
              >
                {settingsOpen && sidebarOpen && (
                  <div className="ml-8 pl-2 mt-1 space-y-1">
                    ...
                    <div className="w-full">
                      ...
                      <div
                        className={`overflow-hidden transition-all duration-300 ease-in-out ${
                          statusOpen && sidebarOpen ? "max-h-96" : "max-h-0"
                        }`}
                      >
                        {statusOpen && (
                          <div className="ml-8 pl-2 mt-1 space-y-1">
          ...
          <div className="px-4 py-4 flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="relative">
                ...
                {languageOpen && (
                  <div
                    className={`absolute right-0 mt-2 w-40 rounded-lg shadow-lg py-2 z-30 border ${
                      darkMode
